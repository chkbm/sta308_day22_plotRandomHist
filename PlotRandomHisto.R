...
plotRandomHisto <- function(num_pts=30, mu=0, sigma=1, 
...
plotRandomHisto()
plotRandomHisto(seed=1)
plotRandomHisto(seed=1, num_pts=1000000)
plotRandomHisto(seed=1, num_pts=1000000, meanColor="forestgreen")
plotRandomHisto(seed=1, num_pts=1000000, meanColor="hotpink")
